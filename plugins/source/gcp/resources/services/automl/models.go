	...
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			},
			{
				...
				Type:     schema.TypeString,
				Resolver: client.ResolveProtoEnum("DeploymentState"),
			},
			{
				Name:     "etag",
				Type:     schema.TypeString,
...
func fetchModels(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
