...
import (
	...
	"github.com/cloudquery/plugins/source/gcp/resources/services/asset"
	"github.com/cloudquery/plugins/source/gcp/resources/services/assuredworkloads"
	"github.com/cloudquery/plugins/source/gcp/resources/services/automl"
	...
	"github.com/cloudquery/plugins/source/gcp/resources/services/cloudbuild"
	"github.com/cloudquery/plugins/source/gcp/resources/services/clouddms"
	"github.com/cloudquery/plugins/source/gcp/resources/services/cloudtasks"
...
func PluginAutoGeneratedTables() []*schema.Table {
	return []*schema.Table{
		...
		clouddms.ConnectionProfiles(),
		clouddms.MigrationJobs(),
		cloudtasks.Queues(),
		compute.Addresses(),
		compute.Autoscalers(),
